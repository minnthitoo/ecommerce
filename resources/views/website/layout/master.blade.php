...
<body
            ...
            @if($errors)
                @foreach ($errors->all() as $error)
                    ...
                    <script>
                        ...
                        title: 'Oops...',
                        text: '{{ $error }}',
                        footer: '<a href="https://apexmmweb.com"> Powered by apexmmweb.com !</a>'
                        })
                    </script>
                @endforeach
             @endif
                        ...
                        <div class="row">
                                ...
                                <div class="widget widget_text widget_logo">
                                    ...
                                    <div class="widget_footer">
                                        <div class="footer-contact">
                                            ...
                                            <p>
                                                <i class="pegk pe-7s-map-marker"> </i><span>No 9/689 , Shwepadar Street
                                                    <br> <span class="pl__30">East Dagon , Yangon</span></span>
                                            </p>
                                            <p><i class="pegk pe-7s-mail"></i>
                                                <span><a
                                                        href="mailto:{{$siteinfo->site_email}}">{{$siteinfo->site_email}}</a></span>
                                            </p>
                                            <p><i class="pegk pe-7s-call"></i> <a href="tel:{{$siteinfo->hot_line}}">
                                                    <span>{{$siteinfo->hot_line}} </span> </a></p>
                                            <div class="nt-social">
                                                <?php
                                ...
                                <div class="widget widget_nav_menu">
                                    ...
                                    <div class="menu_footer widget_footer">
                                        <ul class="menu">
                                            ...
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Terms &amp; Conditions</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Returns &amp; Exchanges</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Shipping &amp; Delivery</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Privacy Policy</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-12 mb__50 order-lg-4 order-1">
                                <div class="widget widget_nav_menu">
                                    ...
                                    <div class="menu_footer widget_footer">
                                        <ul class="menu">
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Store Location</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Latest News</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">My Account</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">Size Guide</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">FAQs 2</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{route('about#us')}}">FAQs</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mb__50 order-lg-5 order-1">
                                <div class="widget widget_text">
                                    <h3 class="widget-title fwsb flex al_center fl_between fs__16 mg__0 mb__30">
                                        <span class="txt_title">Newsletter Signup</span><span
                    ...
                    <div class="container pr tc">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © 2022
                                all rights reserved. Powered by<a href="http://thawzinsoe.apexmmweb.com/">
                                    Apex MM Web</a>
                            </div>
        ...
        <div class="nt_mini_cart nt_js_cart flex column h__100 btns_cart_1">
            ...
            <div class="cart_threshold cart_thres_js">
                <div class="cart_thres_2">Almost there, add
                    <span class="cr fwm mn_thres_js">$9.00</span> more to get <span class="cr fwm">FREE
                        SHIPPING!</span>
                </div>
            </div>
                    ...
                    <div class="fixcl-scroll-content">
                        <div class="empty tc mt__40 dn"><i class="las la-shopping-bag pr mb__10"></i>
                            ...
                            <p class="return-to-shop mb__15">
                                <a class="button button_primary tu js_add_ld" href="shop-filter-sidebar.html">Return
                                    To
                                    Shop</a>
                            </p>
                        </div>
                        ...
                        <div class="mini_cart_items js_cat_items lazyload">
                            ...
                            <div class="mini_cart_item js_cart_item flex al_center pr oh">
                                ...
                                <div class="mini_cart_info">
                                    <a href="product-detail-layout-01.html" class="mini_cart_title truncate">Ridley
                                        High
                                        Waist</a>
                                    <div class="mini_cart_meta">
            ...
            <div class="mini_cart_gift pe_none">
                <div class="shipping_calculator tc">
                    <p class="field">
                        ...
                        <span class="gift_wrap_text mt__10 db"><span class="cd">Do you want a gift wrap?</span>
                            Only
                            $5.00</span>
                    </p>
                    <p class="field">
                ...
                <form method="get" class="search_header mini_search_frm js_frm_search pr" role="search">
                    <div class="row">
                        ...
                        <div class="frm_search_input pr oh col">
                            <input class="search_header__input js_iput_search" autocomplete="off" type="text" name="q"
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    ...
                                                    class="w__100 lazyload" alt="Analogue Resin Strap"
                                                    data-bgset="assets/images/home-fashion-9/pr-s-01.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                ...
                                <div class="row mb__10 pb__10">
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-02.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Ridley High
                                            Waist</a>$36.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-03.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Blush
                                            Beanie</a>$15.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-04.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Cluse La
                                            Boheme
                                            Rose Gold</a>
                                        <del>$60.00</del>
                                        <ins>$45.00</ins>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-05.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Mercury
                                            Tee</a>$68.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-06.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">La Bohème
                                            Rose
                                            Gold</a>
                                        <del>$60.00</del>
                                        <ins>$40.00</ins>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-07.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Cream women
                                            pants</a>$35.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-08.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Black
                                            mountain
                                            hat</a>$50.00
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-09.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-10.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Sport
                                            Sneaker</a>$35.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-11.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Men
                                            pants</a>$49.00–$56.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-12.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-13.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Simple Skin
                                            T-shirt</a>$56.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-14.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Sunny
                                            Life</a>$68.00
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-15.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Leather
                                            White
                                            Trainers</a>$20.00
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="img_fix_search">
                                            <a class="db pr oh" href="product-detail-layout-01.html"><img
                                                    src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
                                                    class="w__100 lazyload" alt=""
                                                    data-bgset="assets/images/home-fashion-9/pr-s-16.jpg"></a>
                                        </div>
                                    </div>
                                    <div class="col-12 mt__10">
                                        <a class="product-title db" href="product-detail-layout-01.html">Stripe Long
                                            Sleeve Top</a>$15.00
                                    </div>
                                </div>
                            </div>
    ...
    <div id="nt_login_canvas" class="nt_fk_canvas dn lazyload">
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        <p class="form-row">
                            ...
                            <input type="email" required name="email" id="CustomerEmail" autocomplete="email"
                                autocapitalize="off">
                        </p>
                        <p class="form-row">
        ...
        <form method="POST" action="{{ route('register') }}" id="RegisterForm" class="nt_mini_cart flex column h__100">
            @csrf
            <div class="mini_cart_header flex fl_between al_center">
                ...
                <div class="mini_cart_content fixcl-scroll">
                    <div class="fixcl-scroll-content">
                        <p class="form-row">
                            ...
                            <input required type="text" name="name" id="-FirstName" autocomplete="given-name">
                        </p>

                        <p class="form-row">
                            <label for="-email">Email <span class="required">*</span></label>
                            <input required type="email" name="email" id="-email" class="" autocapitalize="off"
                                autocomplete="email" aria-required="true">
                        </p>
                        <p class="form-row">
                            <label for="-password">Password <span class="required">*</span></label>
                            <input required type="password" name="password" id="-password" class=""
                                autocomplete="current-password" aria-required="true">
                        </p>
                        <p class="form-row">
                            <label for="-password">Confirm Password <span class="required">*</span></label>
                            <input required type="password" name="password_confirmation" id="-password" class=""
                                autocomplete="current-password" aria-required="true">
                        </p>
            ...
            <div id="kalles-section-mb_nav" class="kalles-section">
                <ul id="menu_mb_ul" class="nt_mb_menu">
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="/"><span class="nav_link_txt flex al_center">Home</span><span
        ...
        <div id="kalles-section-mb_cat_js" class="mb_nav_tab">
            <div id="kalles-section-mb_cat" class="kalles-section">
                <ul id="menu_mb_cat" class="nt_mb_menu">
                    ...
                    <li class="menu-item">
                        <a href="shop-filter-options.html"><i class="las la-male mr__10 fs__20"></i>Men’s
                            Clothing</a>
                    </li>
                    <li class="menu-item">
    ...
    {{-- custom js  --}}
    <script src="{{ asset('assets/js/mines.js') }}"></script>
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.status == 'success'){
                            window.location = 'http://127.0.0.1:8000/shop/'+ $shopId + '/' + $userId;
                        }
                    }
                })
            })
        ...
        // $(document).ready(function () {
            ...
            $(document).ready(function() {
                $('.plus').click(function() {
                    $parentNode = $(this).parents('div.row');
                    $price = Number($parentNode.find('.price').text());
                    $qty = Number($parentNode.find('.qty').val()) + 1;
                    $total = $price * $qty;
                    $parentNode.find('.totalPrice').html($total);
                    $totalPrice = $parentNode.find('.totalPrice').text();
                    $addingPrice = 0;
                    $('#data-table div.row').each(function(index, row) {
                        //console.log($(row).find('.totalPrice').text());
                        $addingPrice += Number($(row).find('.totalPrice').text());
                    });
                    $('div.subTotal').text($addingPrice);
                });
                ...
                //add to whitelist
                $('.addtoWhiteList').click(function(e) {
                    e.preventDefault();
                    $data = {
                        'userId': $('#userId').val(),
                        'productId': $('#productId').val()
                    ...
                    $.ajax({
                        type: "get",
                        url: "http://127.0.0.1:8000/whitelist/add",
                        data: $data,
                        dataType: "json",
                        success: function(response) {
