...
<body
                            ...
                            <div class="row al_center">
                                <div class="col-lg-4 col-12 tc tl_lg col-md-12 ">
                                    <div class="header-text">
                                        <i class="pegk pe-7s-call"></i> +01 23456789 <i
                                            class="pegk pe-7s-mail ml__15"></i>
                                ...
                                <div class="col-lg-4 col-12 tc col-md-12 tr_lg ">
                                    <div class="nt_currency pr cg currencies sp_currencies wsn dib  cur_stt_0">
                                        <span class="nt-currency-flag--usd--w16-h-12 active ">USD</span><i
                                            class="facl facl-angle-down ml__5"></i>
                                        <ul
                                            class="pa pe_none ts__03 bgbl ul_none tl op__0 z_100 r__0 pt__15 pb__15 pr__15 pl__15">
                                            ...
                                            <li><a class="nt-currency-flag--usd--w16-h-12 cg db selected"
                                                    href="#">USD</a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul id="nt_menu_id" class="nt_menu in_flex wrap al_center">
                                                        ...
                                                        <div class="row lazy_menu lazyload"
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-3">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-video-banner.html">Home Video
                                                                            Banner</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="home-categories-links.html">Home
                                                                            Categories Links</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="home-static-image.html">Home Static
                                                                            Image</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-instagram-shop.html">Home
                                                                            Instagram Shop</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-cosmetics.html">Home Cosmetics
                                                                            <span
                                                                                class="lbc_nav lb_menu_new ml__5">new</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-3">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-lookbook-collection.html">Home
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-fashion10.html">Home Fashion
                                                                            10</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-fashion-vertical.html">Home
                                                                            Fashion Vertical</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-electric-vertical.html">Home
                                                                            Electric Vertical</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-one-product-store.html">One
                                                                            Product Store
                                                                            <span
                                                                                class="lbc_nav lb_menu_hot ml__5">hot</span>
                                                                        </a>
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-fashion-trend.html">Home Fashion
                                                                            Trend</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-3">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    <li class="menu-item">
                                                                        <a href="home-header-01.html">Header Layout
                                                                            1</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="home-header-02.html">Header Layout
                                                                            2</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-header-04.html">Header Layout
                                                                            4</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-header-06.html">Header Layout
                                                                            6</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="home-fashion-vertical.html">Header
                                                                            Layout 7</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="home-electric-vertical.html">Header
                                                                            Layout 8</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-3">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    <li class="menu-item">
                                                                        <a href="shop-filter-options.html">Filter
                                                                            options
                                                                            <span
                                                                                class="lbc_nav lb_menu_hot ml__5">hot</span>
                                                                        </a>
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-age-verified.html">Age
                                                                            verification</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="shop-hidden-sidebar.html">Hidden
                                                                            sidebar</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="shop-grid-list-switcher.html">Grid/List
                                                                            switcher
                                                                            <span
                                                                                class="lbc_nav lb_menu_hot ml__5">Hot</span>
                                                                        </a>
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a
                                                                            href="product-detail-pickup-availability.html">Pickup
                                                                            Availability
                                                                            <span
                                                                                class="lbc_nav lb_menu_selling-feature ml__5">Selling
                                                                                Feature</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <div class="row lazy_menu lazyload"
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-2">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="shop-packery-layout.html">Packery
                                                                            Layout</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-masonry-layout.html">Masonry
                                                                            Layout</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-full-width-layout.html">Full Width
                                                                            Layout</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-1600px-layout.html">1600px
                                                                            Layout</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-left-sidebar.html">Left
                                                                            Sidebar</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-right-sidebar.html">Right
                                                            ...
                                                            <div class="type_mn_link menu-item sub-column-item col-2">
                                                                ...
                                                                <ul class="sub-column not_tt_mn">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="shop-filter-sidebar.html">Filters
                                                                            sidebar</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-load-more.html">Load more
                                                                            button</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-Infinite-scrolling.html">Infinite
                                                                            scrolling</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="shop-collection.html">Collections
                                                                            list</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                    ...
                                                                    <li class="menu-item">
                                                                        <a href="home-categories-links.html">Search
                                                                            Fullscreen</a>
                                                                    </li>
                                                                    <li class="menu-item">
                                                                        <a href="checkout.html">Checkout</a>
                                                                    ...
                                                                    <div class="cat_grid_item__content pr oh">
                                                                        <a href="shop-left-sidebar.html"
                                                                            ...
                                                                            <div class="cat_grid_item__overlay item__position nt_bg_lz lazyload padding-top__127_586"
                                                                                data-bgset="assets/images/megamenu/bn-01.jpg">
                                                                            </div>
                                                                        </a>
                                                                        <div class="cat_grid_item__wrapper pe_none">
                                                                            <div class="cat_grid_item__title">Women
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="cat_grid_item cat_space_item">
                                                                    <div class="cat_grid_item__content pr oh">
                                                                        <a href="shop-left-sidebar.html"
                                                                            class="db cat_grid_item__link">
                                                                            <div class="cat_grid_item__overlay item__position nt_bg_lz lazyload padding-top__127_586"
                                                                                data-bgset="assets/images/megamenu/bn-02.jpg">
                                                                            </div>
                                                                        </a>
                                                                        <div class="cat_grid_item__wrapper pe_none">
                                            ...
                                            <li
                                                ...
                                                <a class="lh__1 flex al_center pr kalles-lbl__nav-sale"
                                                    href="shop-filter-sidebar.html">Sale
                                                    ...
                                                    <div class="container megamenu-content-1200px">
                                                        <div class="row lazy_menu lazyload"
                                                            ...
                                                            <div class="type_mn_pr menu-item sub-column-item col-10">
                                                                <div class="prs_nav js_carousel nt_slider products nt_products_holder row al_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 is-draggable"
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div class="product-image pr oh lazyload">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-02.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p class="truncate mg__0 w__100">XS,
                                                                                        S, M, L, XL</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="product-info mt__15">
                                                                                <h3
                                                                                    ...
                                                                                    <a class="cd chp"
                                                                                        href="product-detail-layout-01.html">Analogue
                                                                                        Resin Strap</a>
                                                                                </h3>
                                                                                <span
                                                                                    class="price dib mb__5">$30.00</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div class="product-image pr oh lazyload">
                                                                                ...
                                                                                <a class="d-block"
                                                                                    href="product-detail-layout-01.html">
                                                                                    <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-03.jpg">
                                                                                    </div>
                                                                                </a>
                                                                                <div
                                                                                    class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-04.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="nt_add_w ts__03 pa ">
                                                                                    <a href="#"
                                                                                ...
                                                                                <div
                                                                                    class="product-attr pa ts__03 cw op__0 tc">
                                                                                    <p class="truncate mg__0 w__100">S,
                                                                                        M, L</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="product-info mt__15">
                                                                                <h3
                                                                                    class="product-title pr fs__14 mg__0 fwm">
                                                                                    <a class="cd chp"
                                                                                        href="product-detail-layout-01.html">Ridley
                                                                                        High Waist</a>
                                                                                </h3>
                                                                                <span
                                                                                    class="price dib mb__5">$36.00</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div class="product-image pr oh lazyload">
                                                                                ...
                                                                                <a class="d-block"
                                                                                    href="product-detail-layout-01.html">
                                                                                    <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-05.jpg">
                                                                                    </div>
                                                                                </a>
                                                                                <div
                                                                                    class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-06.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="nt_add_w ts__03 pa ">
                                                                                    <a href="#"
                                                                            ...
                                                                            <div class="product-info mt__15">
                                                                                ...
                                                                                <span
                                                                                    class="price dib mb__5">$15.00</span>
                                                                                <div
                                                                                    class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-05.jpg"
                                                                                    ...
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-31.jpg"
                                                                                        class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                                                            class="tt_txt">Pink</span><span
                                                                                            class="swatch__value bg_color_pink"></span></span>
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-32.jpg"
                                                                                        class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div class="product-image pr oh lazyload">
                                                                                ...
                                                                                <a class="d-block"
                                                                                    href="product-detail-layout-01.html">
                                                                                    <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-07.jpg">
                                                                                    </div>
                                                                                </a>
                                                                                <div
                                                                                    class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-08.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="nt_add_w ts__03 pa ">
                                                                                    <a href="#"
                                                                            ...
                                                                            <div class="product-info mt__15">
                                                                                <h3
                                                                                    class="product-title pr fs__14 mg__0 fwm">
                                                                                    <a class="cd chp"
                                                                                        href="product-detail-layout-01.html">Cluse
                                                                                        La Boheme Rose Gold</a>
                                                                                </h3>
                                                                                ...
                                                                                <div
                                                                                    class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-07.jpg"
                                                                                    ...
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-08.jpg"
                                                                                        class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                                                            class="tt_txt">Grey</span><span
                                                                                            class="swatch__value bg_color_grey"></span></span>
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-06.jpg"
                                                                                        class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div
                                                                                ...
                                                                                <a class="d-block"
                                                                                    href="product-detail-layout-01.html">
                                                                                    <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-09.jpg">
                                                                                    </div>
                                                                                </a>
                                                                                <div
                                                                                    class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-10.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="nt_add_w ts__03 pa ">
                                                                                    <a href="#"
                                                                            ...
                                                                            <div class="product-info mt__15">
                                                                                <h3
                                                                                    ...
                                                                                    <a class="cd chp"
                                                                                        href="product-detail-layout-01.html">Mercury
                                                                                        Tee</a>
                                                                                </h3>
                                                                                <span
                                                                                    class="price dib mb__5">$68.00</span>
                                                                                <div
                                                                                    class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-15.jpg"
                                                                                    ...
                                                                                    <span
                                                                                        data-bgset="assets/images/products/pr-14.jpg"
                                                                                        class="nt_swatch_on_bg swatch__list--item position-relative ttip_nt tooltip_top_right"><span
                                                                                            class="tt_txt">Heart
                                                                                            Dotted</span><span
                                                                        ...
                                                                        <div class="product-inner pr">
                                                                            <div
                                                                                ...
                                                                                <a class="d-block"
                                                                                    href="product-detail-layout-01.html">
                                                                                    <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-11.jpg">
                                                                                    </div>
                                                                                </a>
                                                                                <div
                                                                                    class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                    <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                                                                        data-bgset="assets/images/megamenu/pr-12.jpg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="nt_add_w ts__03 pa ">
                                                                                    <a href="#"
                                                                            ...
                                                                            <div class="product-info mt__15">
                                                                                <h3
                                                                                    class="product-title position-relative fs__14 mg__0 fwm">
                                                                                    <a class="cd chp"
                                                                                        href="product-detail-layout-01.html">La
                                                                                        Bohème Rose Gold</a>
                                                                                </h3>
                                                                                <span class="price dib mb__5">
                                                                                    <del>$60.00</del>
                                            ...
                                            <li
                                                ...
                                                <div class="sub-menu">
                                                    <div class="lazy_menu lazyload">
                                                        ...
                                                        <div class="menu-item">
                                                            <a href="single-portfolio-with-shop.html">Single Portfolio
                                                                With Shop</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="single-portfolio-with-lookbook.html">Single
                                                                Portfolio With Lookbook</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="single-portfolio-with-instagram-shop.html">Portfolio
                                                                With Instagram Shop</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                                                <a class="lh__1 flex al_center pr"
                                                    href="portfolio-3-columns.html">Lookbook</a>
                                                <div class="sub-menu">
                                                    <div class="lazy_menu lazyload">
                                                        <div class="menu-item">
                                                        ...
                                                        <div class="menu-item">
                                                            <a href="product-detail-description-with-lookbook.html">Lookbook
                                                                in product</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="blog-post-with-lookbook.html">Lookbook in blog
                                                                post</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="single-portfolio-with-lookbook.html">Lookbook in
                                                                portfolio post</a>
                                                        </div>
                                                        <div class="menu-item">
                                            ...
                                            <li
                                                ...
                                                <div class="sub-menu">
                                                    <div class="lazy_menu lazyload">
                                                        ...
                                                        <div class="menu-item">
                                                            <a href="blog-post-with-product-listing.html">Single Post
                                                                with Product Listing</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="blog-post-with-instagram-shop.html">Single Post
                                                                with Instagram Shop</a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a href="blog-post-with-instagram-shop.html">Single Post
                                                        ...
                                                        <div class="menu-item">
                                                            <a href="blog-post-with-lookbook.html">Single Post with
                                                                lookbook</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-auto col-md-4 col-3 tr col_group_btns">
                                    <div class="nt_action in_flex al_center cart_des_1">
                                        ...
                                        <a class="icon_like cb chp position-relative dn db_md js_link_wis"
                                            href="wishlist.html"><i class="iccl iccl-heart pr"><span
                                                    class="op__0 ts_op pa tcount bgb br__50 cw tc">3</span></i>
                                        </a>
                                        <div class="icon_cart pr">
                                            <a class="push_side position-relative cb chp db" href="#"
                                                data-id="#nt_cart_canvas"><i class="iccl iccl-cart pr"><span
                                                        class="op__0 ts_op pa tcount bgb br__50 cw tc">5</span></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cat_toolbar row fl_center al_center mt__30">
                    <div class="cat_view col-auto">
                        <div class="dn dev_desktop">
                            <a href="#" data-mode="grid" data-dev="dk" data-col="6"
                                class="pr mr__10 cat_view_page view_6"></a>
                            <a href="#" data-mode="grid" data-dev="dk" data-col="4"
                            ...
                            <a href="#" data-mode="grid" data-dev="dk" data-col="15"
                        ...
                        <div class="kalles-section tp_se_cdt">
                            ...
                            <div class="result_clear mt__30 mb__20 dn">
                                ...
                                <a class="clear_filter dib" href="#">Clear All Filter</a><a href="#"
                                    class="clear_filter dib bf_icons" aria-label="Remove tag Size  M">Size M</a><a
                                    href="#" class="clear_filter dib bf_icons" aria-label="Remove tag Color  Cyan">Color
                                    Cyan</a><a href="#" class="clear_filter dib bf_icons"
                                    ...
                                    <div class="product-inner pr">
                                        <div class="product-image pr oh lazyload">
                                            ...
                                            <a class="d-block" href="product-detail-layout-01.html">
                                                <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                                    data-bgset="assets/images/megamenu/pr-01.jpg"
                                                    style="background:url('{{'public_path/productImage/'.$item->product_image}}')">
                                                </div>
                                            </a>
                                            ...
                                            {{-- <input type="hidden" class="whiteListId" value="{{$item->whitelist_id}}">
                                            --}}
                                            <div class="nt_add_w ts__03 pa">
                                                <a href="{{route('whitelist#delete',$item->whitelist_id)}}"
                                                    class="chp ttip_nt tooltip_right wis_remove"><span
                                        ...
                                        <div class="product-info mt__15">
                                            <h3 class="product-title pr fs__14 mg__0 fwm">
                                                <a class="cd chp"
                                                    href="product-detail-layout-01.html">{{$item->product_name}}</a>
                                            </h3>
                                            <span class="price dib mb__5">{{$item->price}}</span>
                                        </div>
                                    </div>
                                ...
                                {{-- <div
                                    ...
                                    <div class="product-inner pr">
                                        <div class="product-image position-relative oh lazyload">
                                            ...
                                            <div class="nt_add_w ts__03 pa ">
                                                <a href="#" class="cb chp ttip_nt tooltip_right wis_remove"><span
                                                        class="tt_txt">Remove Wishlist</span><i
                                                        class="facl facl-heart-o"></i></a>
                                            </div>
                                            <div class="hover_button op__0 tc pa flex column ts__03">
                                        ...
                                        <div class="footer-contact">
                                            <p>
                                                <a class="d-block" href="index.html">
                                                    <img class="w__100 mb__15 lazyload max-width__95px"
                                            ...
                                            <p><i class="pegk pe-7s-mail"></i>
                                                <span><a
                                                        href="mailto:contact@company.com">contact@company.com</a></span>
                                            </p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mb__50 order-lg-5 order-1">
                                <div class="widget widget_text">
                                    ...
                                    <div class="widget_footer newl_des_1">
                                        ...
                                        <p class="mt__20">
                                            <img class="w__100 lazyload w__max-width__197"
                    ...
                    <div class="container pr tc">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © 2021
                                <span class="cp">Kalles</span> all rights reserved. Powered by <a
                                    href="https://themes.the4.co/kalles-html">The4</a>
                            </div>
                        ...
                        <div class="gecko-scroll-content-quick">
                            <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                                <h1 class="product_title entry-title fs__16">
                                    {{-- <a href="product-detail-layout-01.html">{{$item->product_name}}</a> --}}
                                </h1>
                                ...
                                <div class="pr_short_des">
                                    {{-- <p class="mg__0">{{$item->product_description}}</p> --}}
                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="swatch is-color kalles_swatch_js">
                                                    {{-- <h4 class="swatch__title">Color:
                                                        <span
                                                            class="nt_name_current user_choose_js">{{$item->product_color}}</span>
                                                    </h4> --}}
                                                ...
                                                <div class="swatch is-label kalles_swatch_js">
                                                    {{-- <h4 class="swatch__title">Size:
                                                        <span
                                                            class="nt_name_current user_choose_js">{{$item->product_size}}</span>
                                                    </h4> --}}
                                                    {{-- <ul class="swatches-select swatch__list_pr">
            ...
            <div id="kalles-section-mb_nav" class="kalles-section">
                <ul id="menu_mb_ul" class="nt_mb_menu">
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="home-classic.html"><span class="nav_link_txt flex al_center">Demo</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
                            <li class="menu-item menu-item-has-children only_icon_false">
                                <a href="home-classic.html"><span class="nav_link_txt flex al_center">Home
                                        Pages</span><span class="nav_link_icon ml__5"></span></a>
                            ...
                            <li class="menu-item menu-item-has-children only_icon_false">
                                <a href="home-header-01.html"><span class="nav_link_txt flex al_center">Header
                                        Layouts</span><span class="nav_link_icon ml__5"></span></a>
                                <ul class="sub-sub-menu">
                                    <li class="menu-item">
                    ...
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="shop-filter-sidebar.html"><span class="nav_link_txt flex al_center">Shop</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
                            <li class="menu-item">
                                <a href="shop.html">Grid Layout</a>
                    ...
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="product-detail-layout-01.html"><span
                                class="nav_link_txt flex al_center">Product</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="product-detail-grouped-product.html">Grouped Product<span
                                        class="lbc_nav_mb ml__5 lb_menu_hot">hot</span></a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="product-detail-description-with-instagram-shop.html">Description with instagram
                                    shop</a>
                            </li>
                            <li class="menu-item">
                                <a href="product-detail-product-video.html">Product video<span
                                        class="lbc_nav_mb ml__5 lb_menu_hot">hot</span></a>
                            </li>
                            <li class="menu-item">
                                <a href="product-detail-3d-ar-models.html">Product 3D, AR models<span
                                        class="lbc_nav_mb ml__5 lb_menu_hot">hot</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="portfolio-3-columns.html"><span
                                class="nav_link_txt flex al_center">Portfolio</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
                            <li class="menu-item">
                                <a href="portfolio.html">Portfolio 2 Columns</a>
                    ...
                    <li class="menu-item menu-item-has-children only_icon_false">
                        <a href="home-lookbook-collection.html"><span
                                class="nav_link_txt flex al_center">Lookbook</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
                            <li class="menu-item">
                                <a href="home-lookbook.html">Lookbook Slider</a>
                    ...
                    <li class="menu-item menu-item-btns menu-item-acount">
                        <a href="#" class="push_side" data-id="#nt_login_canvas"><span class="iconbtns">Login /
                                Register</span></a>
                    </li>
                    <li class="menu-item menu-item-infos">
                        <p class="menu_infos_title">Need help?</p>
                        <div class="menu_infos_text">
                            <i class="pegk pe-7s-call fwb mr__10"></i>+01 23456789<br><i
                                class="pegk pe-7s-mail fwb mr__10"></i><a class="cg"
                                href="mailto:claue@domain.com">claue@domain.com</a>
                        </div>
                    </li>
                    <li class="menu-item menu-item-has-children only_icon_false currencies">
                        <a href="#"><span class="current dib flagst4 flagst4-sm flagst4-USD lazyload">USD</span><span
                                class="nav_link_icon ml__5"></span></a>
                        <ul class="sub-menu">
        ...
        <div id="kalles-section-mb_cat_js" class="mb_nav_tab">
            <div id="kalles-section-mb_cat" class="kalles-section">
                <ul id="menu_mb_cat" class="nt_mb_menu">
                    <li class="menu-item">
                        <a href="shop-filter-options.html"><i class="las la-female mr__10 fs__20"></i>Women’s
                            Clothing</a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="shop-1600px-layout.html"><i class="las la-child mr__10 fs__20"></i>Toys, Kids &amp;
                            Baby</a>
                    </li>
                    <li class="menu-item">
        ...
        <div class="popup_cookies_wrap container-fluid pl__0 pr__0" data-stt='{ "day_next": 30,"pp_version":1 }'>
            <div class="row al_center fl_center tc tl_md">
                ...
                <div class="col-12 col-md-auto popup_cookies_btns">
                    <a href="#" class="pp_cookies_more_btn tu dib">More info</a>
                    <a href="#" class="pp_cookies_accept_btn tu dib">Accept</a>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- <script>
        $(document).ready(function () {
            $('.wis_remove').click(function (e) {
                e.preventDefault();
                $data = {
                    'whiteListId': $('.whiteListId').val(),
                }
                console.log($data)
                $.ajax({
                    type: "get",
                    url: "http://127.0.0.1:8000/whitelist/delete",
                    data: $data,
                    dataType: "json",
