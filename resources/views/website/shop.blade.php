...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-5" style="border:0.5px solid;margin:20px">
            <div class="row">
                <div class="col-md-4">
                    <img src="{{asset('/storage/shops')}}/{{$shop->photo}}"
                        style="width:130px;height:130px;padding-top:10px;padding-bottom:10px" class="img-responsive"
                        alt="Shop Logo">
                </div>
                <div class="col-md-6">
                    <b>{{$shop->name}}</b>
                    <b>{{$shop->phone}} | {{$shop->email}}</b>
                    <a href="/shop/{{$shop->id}}/{{$shop->user_id}}" class="btn btn-info">Shop Detail</a>
                    {{-- <b>{{$shop->address}}</b> --}}
                </div>
            </div>
        </div>
                    ...
                    <div class="gecko-scroll-content-quick">
                        <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                            ...
                            <div class="pr_short_des">
                                <p class="mg__0">Go kalles this summer with this vintage navy and white striped v-neck
                                        ...
                                        <div class="variations_button in_flex column w__100 buy_qv_false">
                                            <div class="flex wrap">
                                                <div class="quantity pr mr__10 order-1 qty__true" id="sp_qty_qv">
                                                    <input type="number"
                                                        class="input-text qty text tc qty_pr_js qty_cart_js" value="1"
                            ...
                            <div class="product_meta">
                                ...
                                <span class="posted_in"><span class="cb">Categories:</span> <a
                                        href="shop-filter-options.html" class="cg" title="Accessories">Accessories</a>,
                                    <a href="shop-filter-options.html" class="cg" title="All">All</a>, <a
                                        href="shop-filter-options.html" class="cg" title="Best seller">Best seller</a>,
                                    <a href="shop-filter-options.html" class="cg" title="New Arrival">New Arrival</a>,
                                    <a href="shop-filter-options.html" class="cg" title="Sale">Sale</a>, <a
                                        href="shop-filter-options.html" class="cg" title="Watches">Watches</a>, <a
                                        href="shop-filter-options.html" class="cg" title="Women">Women</a></span>
                                <span class="tagged_as"><span class="cb">Tags:</span> <a href="shop-filter-options.html"
                                        class="cg" title="Color Black">Color Black</a>, <a
                                        href="shop-filter-options.html" class="cg" title="Color Pink">Color Pink</a>, <a
                                        href="shop-filter-options.html" class="cg" title="Price $7-$50">Price
                                        $7-$50</a>, <a href="shop-filter-options.html" class="cg"
                                        title="Vendor Kalles">Vendor Kalles</a>, <a href="shop-filter-options.html"
                                        class="cg" title="Watch">Watch</a>, <a href="shop-filter-options.html"
                                        class="cg" title="women">women</a></span>
                            </div>
                            ...
                            <a href="product-detail-layout-01.html" class="btn fwsb detail_link p-0 fs__14">View full
                                details<i class="facl facl-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="variations_button in_flex column w__100">
                            <div class="flex al_center column">
                                <div class="quantity pr mb__15 order-1 qty__" id="sp_qty_qs">
                                    <input type="number" class="input-text qty text tc qty_pr_js qty_cart_js" step="1"
                                        min="1" max="9999" name="quantity" value="1" inputmode="numeric">
                                    <div class="qty tc fs__14">
